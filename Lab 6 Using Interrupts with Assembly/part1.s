...
END_KEY_ISR:  MOV R0, #0b1111 		//reset interrupt
				LDR R1, =EDGE
				STR R0, [R1]
				POP      {R0-R12}
...
SHOWKEY2:		MOV R0, #0b01011011			//seg7 for 2
				LSL R0, #16
				LDRB R2, [R1, #2]

				B DISPLAY

SHOWKEY3:		MOV R0, #0b01001111	
				LSL R0, #24
				LDRB R2, [R1, #3]

				B DISPLAY				

DISPLAY:		//r1 has HEX address, R2 has the hex to check
